...
export const site = {
  ...
  ogImage:
    "https://raw.githubusercontent.com/craftox-labs/timedart/main/docs/media/welcome.png",
  themeColor: "#15191e",
...
export const narrative = {
  ...
  quotePre:
    "Freelancers, contractors & consultants need to know what they worked on, what it's worth, and to ",
  quoteEm: "get paid",
